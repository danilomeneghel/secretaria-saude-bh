...
@Entity
@Table(name = "de_para_secundario_aud")
public class DeParaSecundarioAud extends EntidadeBase<Long> {
  ...
  * 
  */
  private static final long serialVersionUID = 2115618885472193256L;
  ...
  @Id
	...
	@JoinColumn(name = "id_de_para", foreignKey = @ForeignKey(name = "fk_de_para_de_para_secundario_aud"), nullable = false)
	...
	@JoinColumn(name = "id_revisao", foreignKey = @ForeignKey(name = "fk_revisao_de_para_secundario_aud"), nullable = false)
	@ManyToOne(fetch = FetchType.LAZY)
  ...
  public Long getId() {
    ...
    public void setIdDePara(DePara dePara) {
      this.dePara = dePara;
	}
