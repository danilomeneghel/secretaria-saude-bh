...
public class FiltroPesquisaTipoDeParaDTO extends BaseDTO {
	
	private static final long serialVersionUID = 6500626790886007914L;

	@Parameter(description = "Filtro nome do TipoDePara", required = false)
	@QueryParam("nome")
	private String nome;
	...
	@EnumValues(enumClass=ColunaOrdenacaoTipoDeParaEnum.class, message="Coluna para ordenação inválida.", ignoreCase = true)
