...
public class DeParaSistemaPrimarioValidator
    implements ConstraintValidator<DeParaSistemaPrimarioValido, CadastrarSistemaDeParaDTO> {
  ...
  public boolean isValid(CadastrarSistemaDeParaDTO value, ConstraintValidatorContext context) {
    ...
    if (!isValid) {
      ...
      if (value == null) {
        context
            .buildConstraintViolationWithTemplate("Os dados do Sistema Primário são obrigatórios.")
      ...
      if (value.getIdSistema() == null) {
        context
            .buildConstraintViolationWithTemplate(
                "O campo Sistema Primário do De/Para é obrigatório.")
      ...
      if (value.getIdEmpresa() == null) {
        context
            .buildConstraintViolationWithTemplate(
                "O campo Empresa Primária do De/Para é obrigatório.")
      ...
      if (CollectionUtils.isEmpty(value.getCamposDePara())) {
        context
            .buildConstraintViolationWithTemplate(
                "O campo Codigo e Descrição do De/Para são obrigatório(a). (Sistema Primário)")
